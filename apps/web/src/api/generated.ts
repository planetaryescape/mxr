...
export interface paths {
    ...
    "/api/v1/mail/compose/session/attachment": {
        ...
        get?: never;
        put?: never;
        /** Upload compose attachment */
        post: operations["compose_session_attachment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/mail/contacts/autocomplete": {
        ...
        /** Prefix-search known senders */
        get: operations["contacts_autocomplete"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/mail/contacts/briefing": {
        ...
        /** Recipient briefing for compose context */
        get: operations["mail_contacts_briefing"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/mail/threads/{thread_id}/briefing": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Briefing for a dormant thread */
        get: operations["mail_thread_briefing"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/platform/llm/config": {
        ...
        get: operations["llm_config_get"];
        put?: never;
        /** Update LLM configuration */
        post: operations["llm_config_update"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/platform/saved-searches/update": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Patch a saved search by name */
        post: operations["saved_searches_update"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        ArchiveAskFiltersData: {
            ...
            before?: string | null;
            from?: string | null;
            mode?: components["schemas"]["ArchiveAskMode"];
            to?: string | null;
        };
        /** @enum {string} */
        ...
        DecisionLogEntryData: {
            ...
            decision: string;
            evidence_msg_ids: components["schemas"]["MessageId"][];
            /** Format: date-time */
            extracted_at: string;
            id: string;
        ...
        DraftSafetyContextData: {
            allow_llm?: boolean;
            mode?: components["schemas"]["DraftSafetyModeData"];
            original_message_id?: null | components["schemas"]["MessageId"];
            /**
             * Format: date-time
             * @description When set, the safety pipeline runs the send-time check
        ...
        DraftSafetyIssue: {
            ...
            code: components["schemas"]["DraftSafetyIssueCode"];
            detail?: string | null;
            message: string;
            override_token?: string | null;
            severity: components["schemas"]["DraftSafetySeverity"];
        };
        /** @enum {string} */
        DraftSafetyIssueCode: "no_recipients" | "invalid_recipient" | "missing_reply_all_recipient" | "wrong_recipient" | "missing_attachment" | "reply_all" | "pii_secret" | "tone_mismatch" | "answer_coverage" | "commitment_candidate" | "send_time_note";
        /** @enum {string} */
        DraftSafetyModeData: "check" | "send" | "scheduled_flush";
        DraftSafetyReport: {
            allowed: boolean;
            /** Format: date-time */
            checked_at?: string | null;
            issues: components["schemas"]["DraftSafetyIssue"][];
            verdict?: components["schemas"]["DraftSafetyVerdict"];
        };
        /** @enum {string} */
        ...
        EntityExplanationData: {
            candidates: components["schemas"]["EntityCandidateData"][];
            canonical_name: string;
            citations: components["schemas"]["WhoisCitationData"][];
            /** Format: date-time */
        ...
        LlmConfigData: {
            ...
            enabled: boolean;
            model: string;
            overrides?: null | components["schemas"]["LlmOverridesData"];
            /** Format: int64 */
        ...
        LlmOverridesData: {
            /** @default null */
            answer_coverage: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            archive_ask: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            briefing: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            ...
            /** @default null */
            draft_new: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            draft_refine: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            expert: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            humanize_rewrite: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            relationship_summary: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
            summarize: null | components["schemas"]["LlmOverrideData"];
            /** @default null */
        ...
        OwedReplyRowData: {
            ...
            latest_inbound_msg_id: components["schemas"]["MessageId"];
            /** Format: double */
        ...
        Request: {
            ...
            /** @enum {string} */
            cmd: "CheckDraftSafety";
            context?: components["schemas"]["DraftSafetyContextData"];
            draft: components["schemas"]["Draft"];
        } | {
            /** @enum {string} */
            cmd: "ExtractDraftCommitments";
            draft: components["schemas"]["Draft"];
        } | {
            account_id: components["schemas"]["AccountId"];
            /** @enum {string} */
            ...
            /** @enum {string} */
            cmd: "SuggestCollaborators";
            draft: components["schemas"]["Draft"];
            /** Format: int32 */
            limit?: number;
        } | {
            /** @enum {string} */
            cmd: "GetThreadBriefing";
            refresh?: boolean;
            thread_id: components["schemas"]["ThreadId"];
        } | {
            account_id: components["schemas"]["AccountId"];
            /** @enum {string} */
            cmd: "GetRecipientBriefing";
            email: string;
            refresh?: boolean;
        } | {
            account_id: components["schemas"]["AccountId"];
            allow_list_sender?: boolean;
            /** @enum {string} */
            cmd: "WatchCadence";
            email: string;
            /** Format: double */
            ...
            account_id: components["schemas"]["AccountId"];
            /** @enum {string} */
            cmd: "ListCadenceWatch";
        } | {
            account_id: components["schemas"]["AccountId"];
            /** @enum {string} */
            cmd: "ListCadenceDrift";
        } | {
            account_id: components["schemas"]["AccountId"];
            /** @enum {string} */
            ...
            /** @enum {string} */
            cmd: "ArchiveAsk";
            filters?: components["schemas"]["ArchiveAskFiltersData"];
            /** Format: int32 */
            limit?: number;
            question: string;
        } | {
        ...
        ResponseData: {
            ...
            /** @enum {string} */
            kind: "LlmStatus";
            snapshot: components["schemas"]["LlmStatusSnapshot"];
        } | {
            config: components["schemas"]["LlmConfigData"];
            /** @enum {string} */
            kind: "LlmConfig";
            ...
            candidates: components["schemas"]["DraftCommitmentCandidateData"][];
            /** @enum {string} */
            kind: "DraftCommitments";
        } | {
            /** @enum {string} */
            kind: "OwedReplies";
            rows: components["schemas"]["OwedReplyRowData"][];
        } | {
            answer: components["schemas"]["ArchiveAnswerData"];
            /** @enum {string} */
            kind: "ArchiveAnswer";
        } | {
            decisions: components["schemas"]["DecisionLogEntryData"][];
            /** @enum {string} */
            kind: "DecisionLog";
        } | {
            ...
            extracted: number;
            /** @enum {string} */
            kind: "DecisionLogRebuildSummary";
            /** Format: int32 */
            skipped: number;
        } | {
            /** @enum {string} */
            kind: "SendTimeRecommendationResponse";
            recommendation: components["schemas"]["SendTimeRecommendationData"];
        } | {
            entries: components["schemas"]["RelationshipWatchEntryData"][];
            /** @enum {string} */
            kind: "CadenceWatchList";
        } | {
            /** @enum {string} */
            kind: "CadenceDriftList";
            rows: components["schemas"]["CadenceDriftRowData"][];
        } | {
            briefing: components["schemas"]["ThreadBriefingData"];
            /** @enum {string} */
            kind: "ThreadBriefing";
        } | {
            briefing: components["schemas"]["ThreadBriefingData"];
            /** @enum {string} */
            kind: "RecipientBriefing";
        } | {
            /** @enum {string} */
            kind: "SuggestedCollaborators";
            suggestions: components["schemas"]["SuggestedRecipientData"][];
        } | {
            experts: components["schemas"]["ExpertSuggestionData"][];
            /** @enum {string} */
            kind: "ExpertSuggestions";
        } | {
            entity: components["schemas"]["EntityExplanationData"];
            /** @enum {string} */
        ...
        SenderProfileData: {
            ...
            response_histogram?: components["schemas"]["ResponseTimeBucket"][];
            /** Format: int32 */
            total_inbound: number;
            /** Format: int32 */
            total_outbound: number;
            unanswered_question?: null | components["schemas"]["SenderUnansweredQuestionData"];
            weekly_activity?: components["schemas"]["SenderWeeklyActivityData"][];
        };
        SenderSummaryData: {
            account_id: components["schemas"]["AccountId"];
            display_name?: string | null;
