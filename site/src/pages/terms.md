...
mxr is free and open-source software, dual-licensed under the [MIT License](https://github.com/planetaryescape/mxr/blob/main/LICENSE-MIT) and [Apache License 2.0](https://github.com/planetaryescape/mxr/blob/main/LICENSE-APACHE), at your option. You may use, modify, and distribute mxr in accordance with either license.
...
- **Data loss**: mxr stores email data locally. Hardware failure, accidental deletion, or software bugs could result in loss of local email data. mxr is not a backup solution.
- **Email delivery**: mxr relies on third-party services (Gmail API, IMAP, SMTP) for sending and receiving email. Delivery failures, delays, or errors caused by these services are outside mxr's control.
- **Account access**: OAuth tokens can expire or be revoked. mxr is not responsible for loss of access to your email accounts.
...
For questions about these terms, open an issue on the [GitHub repository](https://github.com/planetaryescape/mxr).
