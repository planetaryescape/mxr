...
fn action_name(action: &Action) -> Option<&'static str> {
    match action {
        ...
        Action::OpenAnalyticsScreen => Some("open_analytics_screen"),
        Action::OpenAnalyticsView(_) => Some("open_analytics_view"),
        Action::NextAnalyticsView => Some("next_analytics_view"),
        Action::PrevAnalyticsView => Some("prev_analytics_view"),
        Action::RefreshAnalytics => Some("refresh_analytics"),
        Action::CycleStorageMode => Some("cycle_storage_mode"),
        Action::CycleStorageGroupBy => Some("cycle_storage_group_by"),
        Action::ToggleStalePerspective => Some("toggle_stale_perspective"),
        Action::AdjustStaleOlderThanDays(_) => Some("adjust_stale_older_than_days"),
        Action::AdjustStaleWithinDays(_) => Some("adjust_stale_within_days"),
        Action::CycleContactsMode => Some("cycle_contacts_mode"),
        Action::RefreshContacts => Some("refresh_contacts"),
        Action::ToggleResponseTimeDirection => Some("toggle_response_time_direction"),
        Action::ToggleSubscriptionsRank => Some("toggle_subscriptions_rank"),
        Action::CycleWrappedWindow => Some("cycle_wrapped_window"),
        Action::StepWrappedYear(_) => Some("step_wrapped_year"),
        Action::AnalyticsRowDrillDown => Some("analytics_row_drill_down"),
        Action::AnalyticsUnsubscribe => Some("analytics_unsubscribe"),
        Action::OpenAnalyticsFilterModal => Some("open_analytics_filter_modal"),
        Action::CloseAnalyticsFilterModal => Some("close_analytics_filter_modal"),
        Action::SubmitAnalyticsFilterModal => Some("submit_analytics_filter_modal"),
        ...
        Action::OpenTab6 => Some("open_tab_6"),
        ...
        Action::DraftAssistCurrentThread => Some("draft_assist_thread"),
        Action::DraftNewForSender => Some("draft_new_for_sender"),
        Action::OpenVoiceProfile => Some("open_voice_profile"),
        Action::RebuildUserVoice => Some("rebuild_user_voice"),
        Action::OpenCommitments => Some("open_commitments"),
