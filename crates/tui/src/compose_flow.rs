...
use crate::mxr_tui::app::{ComposeAction, PendingSend};
use crate::mxr_tui::async_result::ComposeReadyData;
...
pub(crate) fn pending_send_from_edited_draft(data: &ComposeReadyData) -> Result<Option<PendingSend>, String> {
    ...
    let has_errors = issues.iter().any(crate::mxr_compose::ComposeValidation::is_error);
    if has_errors {
