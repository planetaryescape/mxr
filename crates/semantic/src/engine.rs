...
#[cfg(feature = "local")]
use super::text::{
    blob_to_f32s, chunk_text, content_hash, embedding_model, f32s_to_blob, normalize_text,
    prefixed_document, prefixed_query,
};
#[cfg(feature = "local")]
use super::attachments::read_attachment_text;
#[cfg(feature = "local")]
use super::{IndexedChunk, SemanticEngine, SemanticHit, SemanticIndex, FASTEMBED_REVISION};

#[cfg(not(feature = "local"))]
use super::{SemanticEngine, SemanticHit};
