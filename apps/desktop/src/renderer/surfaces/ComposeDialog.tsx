            ...
            <div className="grid h-full min-h-0 grid-cols-1 lg:grid-cols-[minmax(0,1.5fr)_18rem]">
              <section className="flex min-h-0 flex-col">
                <div className="border-b border-outline px-6 py-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <Dialog.Title className="mt-3 text-3xl font-semibold tracking-tight text-foreground">
                ...
                <div className="subtle-scrollbar min-h-0 flex-1 overflow-y-auto px-6 py-5">
                  <div className="rounded-3xl border border-outline bg-panel-muted p-6">
                    <p className="mono-meta">Preview</p>
                    <div
                      className="prose prose-invert mt-4 max-w-none text-foreground-muted [&_a]:text-accent [&_blockquote]:border-outline-strong [&_code]:rounded-md [&_code]:bg-panel [&_code]:px-1 [&_code]:py-0.5"
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-t border-outline px-6 py-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="button"
                      className="rounded-xl border border-outline bg-panel-elevated px-4 py-2 text-sm text-foreground"
              ...
              <aside className="hidden border-l border-outline bg-panel-muted px-5 py-5 lg:block">
                ...
                <div className="mt-4 space-y-2">
                  {props.utilityRail.items.map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-outline bg-panel px-3 py-3 text-sm text-foreground-muted"
                    >
                      {item}
                    </div>
                  ))}
                </div>
                <div className="mt-6 rounded-2xl border border-outline bg-panel px-4 py-4">
